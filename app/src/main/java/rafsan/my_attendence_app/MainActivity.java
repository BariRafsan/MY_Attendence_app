...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] values = {"true", "2019162001"};
        httpRequest(keys, values);

        grid.setOnItemClickListener((adapterView, view, i, l) -> {
            Course course = course_list.get(i);
            Intent intent = new Intent(MainActivity.this, rafsan.my_attendence_app.Attendance.class);
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    ...
                    String data = rafsan.my_attendence_app.JSONParser.getInstance().makeHttpRequest(URL, "POST", params);
